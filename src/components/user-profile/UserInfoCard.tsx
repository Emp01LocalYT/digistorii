...
// Define the type to match your storage structure
type UserType = {
  id?: string;
  firstName: string;
  lastName: string;
...
export default function UserInfoCard() {
  ...
  // State for display and state for the form
  const { user } = useUser();
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  {/* <div className="col-span-2">
                    <Label>Bio</Label>
                    <Input type="text" value={formData?.bio || ""} onChange={handleChange} name="bio" />
                  </div> */}
                </div>
              </div>
            </div>
